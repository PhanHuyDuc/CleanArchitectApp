        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebsitePhoneNumber = table.Column<string>(type: "TEXT", nullable: false),
                    WebsitePhoneNumber2 = table.Column<string>(type: "TEXT", nullable: true),
                    WebsitePhoneNumber3 = table.Column<string>(type: "TEXT", nullable: true),
                    WebsiteEmail = table.Column<string>(type: "TEXT", nullable: false),
                    WebsiteEmail2 = table.Column<string>(type: "TEXT", nullable: true),
                    WebsiteEmail3 = table.Column<string>(type: "TEXT", nullable: true),
                    Fax = table.Column<string>(type: "TEXT", nullable: false),
                    WebsiteUrl = table.Column<string>(type: "TEXT", nullable: false),
                    WebsiteTitle = table.Column<string>(type: "TEXT", nullable: false),
                    WebsiteAdminTitle = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WidgetCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannerCategoryId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentCategoryId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuParentName = table.Column<string>(type: "TEXT", nullable: false),
                    MenuName = table.Column<string>(type: "TEXT", nullable: false),
                    MenuLink = table.Column<string>(type: "TEXT", nullable: false),
                    Order = table.Column<int>(type: "INTEGER", nullable: false),
                    TreeView = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    MenuCategoryId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    WidgetCategoryId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Widgets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Widgets_WidgetCategories_WidgetCategoryId",
                        column: x => x.WidgetCategoryId,
                        principalTable: "WidgetCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Widgets_WidgetCategoryId",
                table: "Widgets",
